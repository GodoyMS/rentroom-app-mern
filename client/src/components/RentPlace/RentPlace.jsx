...
const RentPlace = () => {
  ...
  async function saveToFavorites(ev) {
    ...
    const favoritePlaceData = {
      rentPlace: id,
      name: nameRentPlace,
      monthlyPrice: monthlyPricePlace,
    };
    if (!user) {
      setModalOpen(true);
    } else {
  ...
  return (
    <>
      <Container component="main" style={{paddingBottom:"60px"}} maxWidth="md">
        <CssBaseline />
              ...
              >
                ...
                >
                  <Typography
                    ...
                    align="right"
                  >
                    {format(parseISO(place.date), "MMM dd, yyyy")}
                  </Typography>
                </Box>
                ...
                <Box sx={{ display: "flex", gap: 1, alignItems: "center" }}>
                  ...
                  <Typography
                    ...
                    component="span"
                    color="text.secondary"
                  >{`Max people: ${place.maxPeople}`}</Typography>
                </Box>
                ...
                >
                  ...
                  >{` $ ${place.monthlyPrice} / month`}</Typography>
                </Box>
              </Box>
            </Paper>
          </Grid>
